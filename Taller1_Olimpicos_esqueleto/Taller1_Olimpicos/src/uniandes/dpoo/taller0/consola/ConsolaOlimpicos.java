...
public class ConsolaOlimpicos
{
	...
	/**
	 * Este método recibe le pide al usuario el nombre de un atleta
	 * y busca el pais al cual pertenece y lo muestra en pantalla.
	 * 
	 * @return El nmbre del pais al cual pertenece el atleta.
	 */
	private void consultarPaisAtleta() {
		String nAtleta = input("Por favor ingrese el nombre del atleta");
		Atleta atletaBuscado = calculadora.buscarAtleta(nAtleta);
		Pais paisBuscado = atletaBuscado.darPais();
		String nombrePais = paisBuscado.darNombre();
		System.out.println("El pais al cual pertenece " + nAtleta + "es: " + nombrePais );
